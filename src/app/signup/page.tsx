...
export default function Page() {
  ...
  return isLoading ? (
    ...
    <div className="flex h-screen w-screen overflow-hidden bg-gradient-to-tr from-mindchat-bg-dark to-mindchat-bg-dark-darker p-[20px] pr-0 text-white md:items-center">
